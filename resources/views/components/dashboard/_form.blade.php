<div class="row">
    <div class="col-md-6">
        <div class="input-group input-group-dynamic mb-4">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="File Name"
                aria-label="File Name" aria-describedby="basic-addon1" name="name"
    ...
    <div class="col-md-6">
        <input type="file" name="file" class="form-control @error('file') is-invalid @enderror" id="customFile"
            value="{{ old('file', $file->file) }}" @if(!$file->id)required @endif/>
        @error('file')
        <span class="d-block invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
...
<div class="input-group input-group-dynamic mb-4">
    ...
    <input type="text" name="bin" class="form-control @error('bin') is-invalid @enderror" placeholder="BIN Code"
        aria-label="BIN Code" aria-describedby="basic-addon1" value="{{ old('bin', $file->bin) }}">
...
<div class="form-check m-0">
    <input class="form-check-input @error('access') is-invalid @enderror" name="access" type="checkbox"
        id="flexCheckDefault" @if( old('name', $file->access) == true) checked @endif>
